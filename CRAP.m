...
% each of the candidates, percentages, and vote total.
    ...
    total_votes = str2num(erase(description_string(1,1:total_votes_location),','));
        ...
        mat2sheets(sheet_url,'0',[2,2],candidate_percents);
        ...
        mat2sheets(sheet_url,'0',[2,6],turnout/100);
...
%%
    % Gaussian simulation
        ...
        mat2sheets(sheet_url,'0',[9,2],percent_list);       
        mat2sheets(sheet_url,'0',[4,2],whatever);
        mat2sheets(sheet_url,'0',[6,2],num_wins);
toc
